...
sub render_species_list {
  ...
  my $html = sprintf qq{<div class="static_favourite_species"><h3>Available genomes</h3><div class="species_list_container species-list">$fav_html</div>%s</div>},
    $logins && $user && scalar(@ok_faves) ? 'Favourite' : 'Populaar',
    $logins
